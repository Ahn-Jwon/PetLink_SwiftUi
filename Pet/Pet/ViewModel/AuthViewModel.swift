...
// MARK: 회원가입 및 로그인 ViewModel (Auth)

@MainActor
class AuthViewModel: ObservableObject {
    
    private var auth = AuthService.shared                                        // Firebase인증과 통신
...
//        auth.signout()
    ...
    // MARK: 인증 서비스에 로드되는 것을 받고 자체 로컬에 동기화
    ...
    // MARK: completRegistrationFlow 서비스와 연결
